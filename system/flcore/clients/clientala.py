    ...
    def train(self):
        ...
        for epoch in range(max_local_epochs):
            ...
            for i, (x, y) in enumerate(trainloader):
                ...
                #         print(f"参数 {name} 的梯度：\n{param.grad}")
                self.optimizer.step()
            client_avg_loss = epoch_total_loss / len(trainloader)
            client_total_loss += client_avg_loss
        # 客户端损失
        self.client_avg_loss = client_total_loss / max_local_epochs
